...
public class Knight1 extends JPanel {
    private static int bigDim;
    private static int dim;
    private static int dimension;   
    private final static int[][] KnightsMovement = {{1,-2},{-1,-2},{-2,-1},{-2,1},{-1,2},{1,2},{2,1},{2,-1}};  // knight moves : 8 different ways
    ...
    public static void main (String[] args){
        ...
        frame.getContentPane().add(new Knight1());
        frame.setLocation(0, 500);
        frame.setBackground(Color.WHITE);
        frame.setTitle("Solución 2");
    ...
    public void paint(Graphics g){
        ...
        g.setColor(new Color(184,244,248));
